...
export function Projects({
    ...
    return (
        <AutoRender
            ...
            props={{
                className:
                    "projects-view supernova-display h-fit w-screen text-[10pt] py-[18px] px-[18px] flex flex-col items-center justify-center gap-[18px] rounded-[12px] overflow-hidden",
        ...
        >
            <span className="w-full grow relative rounded-[6px] overflow-hidden">
                <span className="projects-index-container rounded-bl-[8px] px-[16px] py-[2px] z-10 top-0 right-0 absolute">
            ...
            <span className="w-full flex items-center justify-between">
                <span className="size-fit flex flex-row items-center justify-center gap-[12px]">
                    {github ? (
                        <Icons.Github
                            className="projects-icon w-[26px] cursor-pointer"
                    ...
                    {url ? (
                        <Icons.Link
                            className="projects-icon w-[24px] cursor-pointer"
                            fillColor="rgb(var(--supernova-400))"
                ...
                {techstack ? (
                    <span className="projects-techstack flex flex-row items-center py-[4px] px-[20px] gap-[16px] w-fit rounded-[32px] overflow-hidden">
